function [KevinCIFAR48_scores ,KevinCIFAR48_list_im] = matcaffe_batch_CBIR_CIFAR10_48(y_ft_list_im, use_gpu)
...
if exist('use_gpu', 'var')
  matcaffe_init_CBIR_CIFAR10_48(use_gpu);
else
  matcaffe_init_CBIR_CIFAR10_48();
end
...
toc(initic);
KevinCIFAR48_list_im = y_ft_list_im;
KevinCIFAR48_scores = y_ft_scores;
%if exist('filename', 'var')
%    save([filename '_KevinCIFAR48.probs.mat'],'KevinCIFAR48_list_im','KevinCIFAR48_scores','-v7.3');
%end
