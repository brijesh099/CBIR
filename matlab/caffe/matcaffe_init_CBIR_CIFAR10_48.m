function  matcaffe_init_CBIR_CIFAR10_48(use_gpu, model_def_file, model_file)
...
if nargin < 2 || isempty(model_def_file)
  ...
  model_def_file = './examples/cbir-cifar10/CIFAR10_CBIR_48_deploy.prototxt';
end
if nargin < 3 || isempty(model_file)
  model_file = './examples/cbir-cifar10/CBIR_GPU.caffemodel';
end
